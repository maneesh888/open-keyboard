<!-- Keep this review brief concise. Do not paste raw logs, secrets, or gateway responses. -->
...
<!-- One row per in-scope requirement. Do not combine independent requirements. -->
<!-- Status must remain UNVERIFIED until the exact required proof has been inspected. -->
