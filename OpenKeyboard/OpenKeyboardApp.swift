...
struct OpenKeyboardApp: App {
    ...
    private static func seedUITestKeyboardSuggestionStateAtLaunchIfNeeded() {
        ...
        let allowedStates = ["correctionCard", "correctionOnly", "correctionComplete", "correctionDetail", "correctionCarousel", "rewriteOptions", "improvePanel", "actionCarouselPanel", "actionLoadingPanel", "translatePanel", "translationWarning", "allGood", "analysisFailed", "analyzing", "modelCapabilityError", "automaticModelCapabilityWarning"]
